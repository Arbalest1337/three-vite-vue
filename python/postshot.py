...
def read_ply_and_compute_colors(ply_path):
    ...
    return coords, colors, opacity, scale, rotation


def write_full_ply(coords, colors, opacity, scale, rotation, out_path):
...
if __name__ == "__main__":
    ...
    coords, colors, opacity, scale, rotation = read_ply_and_compute_colors(
        args.input_ply
    )

    write_full_ply(coords, colors, opacity, scale, rotation, f"_{args.input_ply}")
